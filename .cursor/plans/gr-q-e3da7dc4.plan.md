<!-- e3da7dc4-2776-4f8c-a751-58bcd4f4f042 91c37b73-8616-4475-9153-440e042829a0 -->
...
The path forward is clear. The destination is profound: understanding how spacetime itself might emerge from quantum information.

### To-dos

- [ ] Problem 2.1: Compute R_uu on null hypersurfaces using EinFields
- [ ] Problem 2.2: Visualize trapped surfaces and null expansions
- [ ] Problem 2.3: Trace event horizon as causal boundary
- [ ] Problems 3.1-3.2: von Neumann entropy and density matrices
- [ ] Problem 3.3: Strong subadditivity and entanglement structure
- [ ] Problem 3.4: First law and black hole thermodynamics connection
- [ ] Problems 3.5-3.7: Quantum channels and holographic encoding
- [ ] Grand synthesis: Neural network learning geometry from entanglement